var todo = function() {
    ...
    function handleRequest() {
        ...
        if (req === "quit") {
            ...
            document.getElementById("result").innerHTML = tasks || "No tasks available!";
        }
        else if (req === "add") {
            ...
            document.getElementById("result").innerHTML = "Invalid command! Please use 'add', 'list', or 'quit'.";
        }

        // Re-trigger the function for continuous prompts until the user quits
        setTimeout(handleRequest, 100);  // Use a small delay to avoid locking the browser
    }
